...
CMDS:
 ...
 ELSE
    DW 0 ; C
 ENDIF
 IF (DLOAD_CMD > 0) && (BASIC_EXTENSION == 1)
    DW CMDS_D ; D
 ELSE
	DW 0
 ENDIF
...
ARTINFO:
   ...
   LD (DE),A
	...
	CALL CALBAS
   PUSH HL
   LD HL,SOUND_CMDS+2*RAM_CMDS+4*VRAM_CMDS+8*BLIT_CMDS+16*SPRITE_CMDS+32*GENCAL_CMD+64*TILE_CMDS+128*BOX_CMDS+256*ANIM_CMDS+512*COLL_CMD+1024*BASIC_EXTENSION+2048*DEFUSR_EXTENSION+4096*DECOMP_CMDS+8192*DLOAD_CMD
   EX DE,HL
   LD (HL),E
   INC HL
   LD (HL),D
